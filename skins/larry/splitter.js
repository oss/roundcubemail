...
function rcube_splitter(attrib)
  ...
  this.maxLeft = attrib.maxLeft ? attrib.maxLeft * 1 : 0;
  this.maxWidth = attrib.maxWidth ? attrib.maxWidth * 1 : 0;
  ...
  this.resize = function()
    ...
    if (this.horizontal)
      ...
      //NAVEEN CODE
      if (this.maxWidth && this.maxLeft) {
	      if (Math.ceil(this.pos + this.layer.width / 2) > this.maxLeft){
    			this.p2.style.left=this.maxLeft+10+'px';
		        this.layer.move(this.maxLeft, this.layer.y);
	      } 
	      else if (Math.ceil(this.pos + this.layer.width / 2) < this.maxWidth+10) {
			this.p2.style.left=this.maxWidth+10+'px';
		        this.layer.move(this.maxWidth, this.layer.y);
		}
		else {
  ...
  this.onDragStart = function(e)
	...
	$('#bluebox').select(function(e) {e.preventDefault();});
