...
show_markmenu: function(show)
{
  ...
  if (show) {
    ...
    var domref = document.getElementById("markbutton");
    var offh = domref.offsetHeight;
    obj.css({ left:pos.left-5, top:(pos.top + (above ? -obj.height() : offh)) });
  }
